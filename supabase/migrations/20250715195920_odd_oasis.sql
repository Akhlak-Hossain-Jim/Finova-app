...
('Shopping', 'shopping-bag', '#ff6a00', ARRAY['Clothing', 'Online Shopping', 'General Shopping', 'Electronics'], false),
...
('Household', 'package', '#ff6a00', ARRAY['Cookeries', 'Household Items', 'Furniture', 'Appliances'], false),
