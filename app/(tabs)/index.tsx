...
import { Plus, TrendingUp, TrendingDown, Target, Calendar } from 'lucide-react-native';
          ...
          <Card style={[styles.noDataCard, { backgroundColor: theme.colors.surface }]}>
            <Card.Content>
              ...
              <View style={styles.noDataButtons}>
                ...
                <Button
                  mode="outlined"
                  onPress={() => {/* Navigate to expenses tab */}}
                  style={styles.addButton}
                >
                  Add Expense
                </Button>
                ...
                <Card.Content>
                  <View style={styles.summaryCardContent}>
                    ...
                    <View style={styles.summaryText}>
                      <Text style={[styles.summaryAmount, { color: theme.colors.onPrimaryContainer }]}>
              ...
              <Card style={[styles.summaryCard, { backgroundColor: theme.colors.errorContainer }]}>
                <Card.Content>
                  <View style={styles.summaryCardContent}>
                    ...
                    <View style={styles.summaryText}>
                      <Text style={[styles.summaryAmount, { color: theme.colors.onErrorContainer }]}>
                        {formatCurrency(monthlyExpenses)}
                      </Text>
                      <Text style={[styles.summaryLabel, { color: theme.colors.onErrorContainer }]}>
                        Monthly Expenses
                      </Text>
                    </View>
                  </View>
              ...
              <Card style={[styles.summaryCard, { backgroundColor: theme.colors.secondaryContainer }]}>
                <Card.Content>
                  <View style={styles.summaryCardContent}>
                    ...
                    <View style={styles.summaryText}>
                      <Text style={[styles.summaryAmount, { color: theme.colors.onSecondaryContainer }]}>
              ...
              <Card style={[styles.summaryCard, { backgroundColor: theme.colors.tertiaryContainer }]}>
                <Card.Content>
                  <View style={styles.summaryCardContent}>
                    ...
                    <View style={styles.summaryText}>
                      <Text style={[styles.summaryAmount, { color: theme.colors.onTertiaryContainer }]}>
                        {savingsRate}%
                      </Text>
